...
class ManualCarStatic  {
    ...
    public ManualCarStatic (String brand, String model) {
        this.brand = brand;
        this.model = model;
...
public class StaticPolymorphism {
    public static void main(String[] args) {
        ManualCarStatic  myManualCarStatic  = new ManualCarStatic ("Suzuki", "WagonR");
        myManualCarStatic .startEngine();
        myManualCarStatic .accelerate();      
        myManualCarStatic .accelerate(40);    
        myManualCarStatic .brake();
        myManualCarStatic .stopEngine();
    }
}
